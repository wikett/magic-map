...
let descripcionSEO = "";
const dominio = "www.subexpuesta.com";
const profesional = "photography"; // siempre en ingles
const autores = "Quique Aparicio";
const categorias = [
  "Astrobiologia",
  "Astrologia",
  "Astronomos",
...
async function createArticle() {
  ...
  let fullUrlArticle = "https://" + dominio + "/blog/" + categoriaSEO + "/" + urlSEO;
